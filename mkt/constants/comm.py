...
ESCALATION_RESERVED_PERMS_APP = 23
...
NOTE_TYPES = {
    ...
    REREVIEW_MANUAL: _('Manual re-review requested'),
    ESCALATION_VIP_APP: _('Escalation due to VIP App'),
    ESCALATION_RESERVED_PERMS_APP: _('Escalation due to reserved permissions'),
...
COMM_MAIL_MAP = {
    ...
    ESCALATION_RESERVED_PERMS_APP: 'escalation_reserved_perms_app',
...
def ACTION_MAP(activity_action):
    ...
    return {
        ...
        mkt.LOG.REREVIEW_MANUAL.id: REREVIEW_MANUAL,
        mkt.LOG.CONTENT_RATING_TO_ADULT.id:
            REREVIEW_CONTENT_RATING_ADULT,
        mkt.LOG.ESCALATION_VIP_APP.id: ESCALATION_VIP_APP,
        mkt.LOG.ESCALATION_RESERVED_PERMS_APP.id:
            ESCALATION_RESERVED_PERMS_APP,
