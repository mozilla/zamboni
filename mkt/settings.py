...
AMO_LANGUAGES = (
    'af', 'ar', 'bg', 'bm', 'bn-BD', 'bn-IN', 'ca', 'cs', 'cy', 'da', 'de',
    'dsb', 'ee', 'el', 'en-GB', 'en-US', 'es', 'eu', 'ff', 'fr', 'fy_NL',
    'ga-IE', 'ha', 'hi-IN', 'hsb', 'hu', 'id', 'ig', 'it', 'ja', 'ko', 'mg',
    'nb-NO', 'nl', 'pl', 'pt-BR', 'ro', 'ru', 'sk', 'sl', 'sq', 'sr',
    'sr-Latn', 'sv-SE', 'sw', 'tr', 'uk', 'wo', 'xh', 'yo', 'zh-CN', 'zh-TW',
    'zu',
)
