...
from mkt.search.views import NonPublicSuggestionsView, RocketbarViewV2
...
urlpatterns = patterns(
    ...
    url(r'^apps/search/suggest/non-public/',
        NonPublicSuggestionsView.as_view(),
        name='non-public-suggestions-search-api'),
