...
if confirm "Process your debug languages?"; then
    ...
    podebug --rewrite=flipped locale/templates/LC_MESSAGES/django.pot locale/rtl/LC_MESSAGES/django.po
    podebug --rewrite=flipped locale/templates/LC_MESSAGES/djangojs.pot locale/rtl/LC_MESSAGES/djangojs.po
fi
...
if confirm "Convert Cyrillic Serbian to Latin?"; then
    ...
    msgfilter -i sr/LC_MESSAGES/djangojs.po -o sr_Latn/LC_MESSAGES/djangojs.po recode-sr-latin
    popd > /dev/null
fi
